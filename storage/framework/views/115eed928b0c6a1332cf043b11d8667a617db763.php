...
Our experienced developers are always assuring the quality of finished product before delivering to the customers. 
        ...
        <div class="numbers section-padding bg-img" data-overlay-dark="6" data-background="<?php echo asset('/frontend/img/bg2.png'); ?>">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="owl-carousel owl-theme col-sm-12">
                        <div class="titem text-center">
                            <div class="team-img">
                                <img src="<?php echo asset('/frontend/img/team/1.jpg'); ?>" alt="">
                            </div>
                            <div class="info">
                        ...
                        <div class="titem text-center">
                            <div class="team-img">
                                <img src="<?php echo asset('/frontend/img/team/2.jpg'); ?>" alt="">
                            </div>
                            <div class="info">
                                <h6>Zayar Myo.</h6>
                        ...
                        <div class="titem text-center">
                            <div class="team-img">
                                <img src="<?php echo asset('/frontend/img/team/3.jpg'); ?>" alt="">
                            </div>
                            <div class="info">
                        ...
                        <div class="titem text-center">
                            <div class="team-img">
                                <img src="<?php echo asset('/frontend/img/team/4.jpg'); ?>" alt="">
                            </div>
                            <div class="info">
                                <h6>Jack Feeedom.</h6>
                        ...
                        <div class="titem text-center">
                            <div class="team-img">
                                <img src="<?php echo asset('/frontend/img/team/5.jpg'); ?>" alt="">
                            </div>
                            <div class="info">
                                <h6>Zaw Win Ge.</h6>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-6">
                        <div class="brand">
                            <img src="<?php echo asset('/frontend/img/clients-logo/fourth-regional-SLW.png'); ?>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2 col-sm-6">
                        <div class="brand">
                            <img src="<?php echo asset('/frontend/img/clients-logo/Logo PSD.png'); ?>" alt="">
                        </div>
                    </div>
