<!-- =====================================
                        ...
                        <div class="info valign">
                            ...
                            <div class="vertical-center">
                                <div class="item">
                                    ...
                                    <div class="cont">
                                        <h6>Phone : </h6>
                                        <p>+95 953 21 314, 94250 23 762</p>
                                    </div>
                                </div>
                                <div class="item">
                                    ...
                                    <div class="cont">
                                        <h6>Address : </h6>
                                        <p>115/Na Gyi, U Yae Khel Street</p>
                                        <p>Mayan Gone (2) Quarter, Yangon, Myanmar</p>
                                    </div>
                                </div>
                                <div class="item">
                                    ...
                                    <div class="cont">
                                        <h6>Email : </h6>
                                        <p>jackfreedom@gracemyanmar.com</p>
                                    </div>
                                </div>
                            </div>
    	...
    	<footer class="text-center">
            <div class="container">
                ...
                <!-- Logo -->
                <a class="logo" href="#">
                    <img style="width: 75%;" src="<?php echo asset('/frontend/img/logo-light-bot.png'); ?>" alt="logo">          
                </a>
                ...
                <p>&copy; 2018 Grace Myanmar. All Rights Reserved.</p>
