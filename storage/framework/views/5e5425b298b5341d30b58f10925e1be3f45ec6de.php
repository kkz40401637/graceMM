...
<div id="wrapper">
                ...
                <div class="hero-wrap" id="sec1" data-scrollax-parent="true">
                    ...
                    <div class="slider-carousel-wrap full-height fullscreen-slider-wrap">
                        <div class="fullscreen-slider full-height cur_carousel-slider-container fl-wrap" data-slick='{"autoplay": true, "autoplaySpeed": 4000 , "pauseOnHover": false}'>
                            ...
                            <div class="fullscreen-slider-item full-height fl-wrap">
                                <div class="bg par-elem"  data-bg="<?php echo asset('frontend/images/bg/z1.jpg'); ?>"></div>
                                <div class="overlay"></div>
                                <div class="half-hero-wrap">
                                    <h1>Hi there!<br>I'm  Yar Zar Lin Aung<br>Independent <span> Full Stack Developer </span></h1>
                                    <h4>I create web and outsource projects</h4>
                            ...
                            <!-- fullscreen-slider-item-->
                            <div class="fullscreen-slider-item full-height fl-wrap">
                                <div class="bg par-elem" rotate="90" data-bg="<?php echo asset('frontend/images/bg/z2.jpg'); ?>"></div>
                                <div class="overlay"></div>
                                <div class="half-hero-wrap">
                                    <h1>Design<br>Creative Design and <br>  <span>Brand Perception.</span></h1>
                                    <h4>I create web and outsource projects</h4>
                                    <div class="clearfix"></div>
                                    <a href="portfolio" class="btn float-btn flat-btn color-btn mar-top">My Portfolio</a> 
                                </div>
                            </div>
                            <!-- fullscreen-slider-item end-->                                   	
                            <!-- fullscreen-slider-item-->
                            <div class="fullscreen-slider-item full-height fl-wrap">
                                <div class="half-hero-wrap">
                                    <h1>Suitable Design and Features <br>With Reasonable Price  <span><br>and High Quality  Code.</span></h1>
                                    <h4>I create web and outsource projects</h4>
                                    <div class="clearfix"></div>
                                    <a href="services" class="btn float-btn flat-btn color-btn mar-top">My services</a> 
                                </div>
                                <div class="bg par-elem"  data-bg="<?php echo asset('frontend/images/bg/z3.jpg'); ?>"></div>
                                <div class="overlay"></div>
                            </div>
                            <!-- fullscreen-slider-item end-->                                    
                        </div>
                    ...
                    <!--hero dec-->
                    <div class="hero-decor-numb"><span>40.7143528  </span><span>-74.0059731 </span> <a href="https://www.google.com.ua/maps/" target="_blank" class="hero-decor-numb-tooltip">Based In Yangon</a></div>
                </div>
                <!-- hero-wrap end-->
                <!-- Content-->
                <div class="content">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="collage-image fl-wrap">
                                        <div class="collage-image-title" data-scrollax="properties: { translateY: '150px' }">Yar Zar Lin Aung</div>
                                        <img src="<?php echo asset('frontend/images/all/1.jpg'); ?>" class="respimg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <div class="main-about fl-wrap">
                                        <h5>My Awesome Story</h5>
                                        <h2>Innovative solutions<br>to boost <span> your creative </span>  projects</h2>
                                        <p>I am Yar Zar Lin Aung. During attending the UCSY, the most interested subject for me in the course is the object-oOriented Programming Language. And also it become the first step to become a developer. After that I got a change to become a good Developer Bye makeing freelancer. NTTDATA Myanmar is the first company I joined. I wroked 4 years in NTTDATA Company. In company, I do the UNICA Project(Update), Terasoluna Framework(Upgrade), Zipc-Tera Framework(Upgrade), Research Group(Tensa Flow Digit Prediction) and HTS Project(Intra-Mast Framework). When I working in NTTDATA Company, I also attending Business in Information Technology in KMD.
                                        <br>
                                        For now, I write a library project for the New Vision Library that nerar from my house. This project is easily to manage the library's member, member card, book and report. I donate this project to that library because I love reading. I also want to supoort for the one who love reading. </p>
                                        ...
                                        <div class="features-box-container fl-wrap">
                                            <div class="row">
                                                ...
                                                <div class="features-box col-md-6">
                                                    ...
                                                    <h3>Web Design</h3>
                                                    <p>I create the project with Responsive, Creative and Elegant Design</p>
                                                </div>
                                                <!-- features-box end  --> 
                                                <!--features-box --> 
                                                <div class="features-box col-md-6">
                                                    ...
                                                    <h3>Ui/Ux Design</h3>
                                                    <p>Most of my project is easily to use even for Novice User </p>
                                                </div>
                                                <!-- features-box end  --> 
                                                <!--features-box --> 
                                                <div class="features-box col-md-6">
                                                    ...
                                                    <h3>Branding</h3>
                                                    <p>I also clear understand about brand and how to maintain it.</p>
                                                </div>
                                                <!-- features-box end  -->                                
                                                <!--features-box --> 
                                                <div class="features-box col-md-6">
                                                    ...
                                                    <h3>Ecommerce</h3>
                                                    <p>Ecommerce is good for the users who busy. So, Creating ecommerce is suitable for for everyone mostly employee. And I also write the ecommerce project.</p>
                                                </div>
                                                <!-- features-box end  -->  
                                            </div>
                                        </div>
                                        <!-- features-box-container end  -->
                                        <a href="portfolio" class="btn float-btn flat-btn color-btn">My Portfolio</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- section end-->
                    <!-- section (from section - > parallax-sec-half-right)-->
                    <section class="parallax-section dark-bg sec-half" data-scrollax-parent="true">
                        <div class="bg par-elem"  data-bg="<?php echo asset('frontend/images/bg/1.jpg'); ?>" data-scrollax="properties: { translateY: '30%' }"></div>
                        <div class="overlay"></div> 
                        <div class="container">
                            <div class="section-title">
                                <h2>Some Interisting <span>Facts </span> <br> About Me</h2>
                                <p style="font-size: 14px;"> 
                                I have a wide range of knowledge about system specifically concenting with customer need. Most of my knowledge is upgerading the framework and other outsource small business projects.</p>
                            ...
                            <div class="fl-wrap facts-holder">
                                ...
                                <div class="inline-facts-wrap">
                                    <div class="inline-facts">
                                        <div class="milestone-counter">
                                            <div class="stats animaper">
                                                <div class="num" data-content="0" data-num="15">15</div>
                                            </div>
                                        </div>
                                ...
                                <div class="inline-facts-wrap">
                                    <div class="inline-facts">
                                        <div class="milestone-counter">
                                            <div class="stats animaper">
                                                <div class="num" data-content="0" data-num="6285">6285</div>
                                            </div>
                                        </div>
                                        <h6>Working hours</h6>
                                    </div>
                                ...
                                <div class="inline-facts-wrap">
                                    <div class="inline-facts">
                                        <div class="milestone-counter">
                                            <div class="stats animaper">
                                                <div class="num" data-content="0" data-num="3460">3460</div>
                                            </div>
                                        </div>
                                        <h6>Coffee Cups</h6>
                                    </div>
                    ...
                    <section data-scrollax-parent="true" id="sec3">
                        ...
                        <div class="container">
                            ...
                            <div class="section-title fl-wrap">
                                <h3 style="font-size: 17px;">Some Words About Me</h3>
                                <h2>My Awesome <span> Work History</span></h2>
                                <p style="font-size: 14px;">
                                    I have a wide range of knowledge about system specifically concenting with customer need. Most of my knowledge is upgerading the framework and other outsource small business projects.  
                                </p>
                            </div>
                            <!-- section-title end -->
                            <!-- custom-inner-holder -->
                            <div class="custom-inner-holder">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="custom-inner-header workres">
                                                ...
                                                <h3> Work in company "NTTDATA MYANMAR"</h3>
                                                <span>  Feb 25,2013 - Feb 15,2017 </span>
                                            </div>
                                            <div class="ci-num"><span>01 --</span></div>
                                        </div>
                                        <div class="col-md-4"><img src="<?php echo asset('frontend/images/all/1.jpg'); ?>" class="respimg" data-scrollax="properties: { translateY: '-170px' }" alt=""></div>
                                        <div class="col-md-4">
                                            <div class="custom-inner-content fl-wrap">
                                                <h4>Complete the project "UNICA"</h4>
                                ...
                                <div class="custom-inner">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><img src="<?php echo asset('frontend/images/all/2.jpg'); ?>" class="respimg" data-scrollax="properties: { translateY: '270px' }" alt=""></div>
                                    </div>
                                </div>
                                <!-- custom-inner end -->
                                <!-- custom-inner -->
                                ...
                                <div class="custom-inner">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"><img src="<?php echo asset('frontend/images/all/3.jpg'); ?>" class="respimg" data-scrollax="properties: { translateY: '100px' }" alt=""></div>
                                        <div class="col-md-4">
                                            <div class="custom-inner-content fl-wrap">
                    ...
                    <div class="subfooter fl-wrap">
                        <div class="container">
                            ...
                            <div class="policy-box">
                                <span>&#169; Yar Zar Lin Aung 2018  /  All rights reserved. </span>
                            </div>
                            <!-- policy-box end-->
...
<?php echo $__env->make('frontend.template.layout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>